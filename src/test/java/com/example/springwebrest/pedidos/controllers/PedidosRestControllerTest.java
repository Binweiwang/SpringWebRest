package com.example.springwebrest.pedidos.controllers;
...
class PedidosRestControllerTest {
    ...
    private final Pedido pedido1 = Pedido.builder()
            ...
            .idUsuario(1L)
            .cliente(
                    new Cliente("Binwei", "binwei@binwei.com", "1234567890",
    ...
    @Test
    void getPedidosNotFoundBadRequest() throws Exception {
        // Arrange
    ...
    @Test
    void getPedidosNotStockBadRequest() throws Exception {
        // Arrange
