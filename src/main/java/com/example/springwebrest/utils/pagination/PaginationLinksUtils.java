package com.example.springwebrest.utils.pagination;
...
public class PaginationLinksUtils {
    ...
    public static String createLinkHeader(Page<?> page, UriComponentsBuilder uriBuilder) {
    ...
    private static String constructUri(int newPageNumber, int size, UriComponentsBuilder uriBuilder) {
