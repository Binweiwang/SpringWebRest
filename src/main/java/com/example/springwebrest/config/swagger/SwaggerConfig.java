package com.example.springwebrest.config.swagger;
...
class SwaggerConfig {
        ...
        return new OpenAPI()
                .info(
                        new Info()
                                ...
                                .contact(
                                        new Contact()
                                                .name("Binwei")
                                                .email("Binweiwang1029@gmail.com")
                                )
                ...
                .externalDocs(
                        new ExternalDocumentation()
                                ...
                                .url("https://github.com/Binweiwang/SpringWebRest")
                )
                .externalDocs(
                        new ExternalDocumentation()
    ...
    GroupedOpenApi httpApi() {
        return GroupedOpenApi.builder()
                ...
                .displayName("Tienda Spring Boot")
                .build();
    }
}